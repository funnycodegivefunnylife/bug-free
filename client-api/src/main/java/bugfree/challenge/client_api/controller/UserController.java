...
public class UserController {
    ...
    public ResponseEntity<ListUsersResponse> listUsers(
        ...
        List<UserDto> userDtos = response.getUsers().stream()
            .map(userMapper::toDto)
            .toList();
        
        ListUsersResponse apiResponse = new ListUsersResponse(
            userDtos,
    ...
    public static class ListUsersResponse {
        ...
        public ListUsersResponse(List<UserDto> users, long totalCount, int page, int size, int totalPages) {
            this.users = users;
